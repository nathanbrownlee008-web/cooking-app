...
const starterRecipes = [
  {
    ...
    "notes": [
      "If the chicken is giving off water in the pan, the pan is crowded or not hot enough.",
      "Garlic only needs a short burst of heat — once it darkens, it turns bitter.",
      "Chicken is ready when it feels firm and cooked through, but still juicy when cut."
    ],
    "steps": [
      {
      ...
      },
      {
        ...
        "heat": "Medium-high",
        "time": "2 min",
        "body": "Warm a frying pan fully before adding the oil. The oil should loosen and shimmer, but it should not be smoking aggressively. The pan is ready when the oil looks loose and shimmery, not when it is smoking hard."
      },
      {
        "title": "Sear the first side",
        "heat": "Medium-high",
        "time": "5-6 min",
        "body": "Lay the chicken into the pan and leave it alone. Do not keep nudging it. Let a rich golden crust develop before you even think about turning it. Wait for real colour before turning because browning is where much of the flavour comes from."
      },
      {
        "title": "Flip and finish the chicken",
        "heat": "Medium",
        "time": "4-5 min",
        "body": "Turn the chicken and cook the second side until almost done. Remove it to a plate so you can use the same pan for the sauce. The final dish should look glossy and balanced, not watery, dull, or greasy."
      },
      {
        "title": "Build the garlic cream sauce",
        "heat": "Low-medium",
        "time": "3-4 min",
        "body": "Add the butter, then the garlic for 30 to 45 seconds until fragrant. Pour in the cream and stock, stir in the parmesan, and let the sauce bubble gently until it thickens slightly. If the smell turns sharp or bitter, the heat is too high and the aromatics are starting to catch."
      },
      {
        "title": "Glaze and finish",
        "heat": "Low",
        "time": "2-3 min",
        "body": "Return the chicken with any juices. Spoon the sauce over the top until the meat is fully cooked and glossy. Finish with lemon juice and parsley before serving. The final dish should look glossy and balanced, not watery, dull, or greasy."
      }
    ],
    "plating": [
  ...
  },
  {
    ...
    "ingredients": [
      ...
      "1/2 tsp black pepper",
      "1 tbsp oil",
      "2 garlic cloves or 1 small onion",
    ...
    "steps": [
      ...
      },
      {
        ...
        "heat": "Medium-high",
        "time": "2 min",
        "body": "Warm the pan fully before adding oil. You want instant sizzle when the chicken hits, not a lazy pale start. The pan is ready when the oil looks loose and shimmery, not when it is smoking hard."
      },
      {
        "title": "Brown for flavour",
        "heat": "Medium-high",
        "time": "6-8 min",
        "body": "Cook the chicken in a single layer and leave it long enough to build golden colour before turning. That colour is where much of the flavour comes from. Wait for real colour before turning because browning is where much of the flavour comes from."
      },
      {
        "title": "Build the sauce or seasoning",
        "heat": "Medium",
        "time": "4-6 min",
        "body": "Add the aromatics and any sauce ingredients, keeping the heat controlled so nothing burns. The pan should smell rich, not harsh or bitter. Pieces should be even in size and dry on the surface before cooking starts."
      },
      {
        "title": "Finish gently",
        "heat": "Low-medium",
        "time": "3-5 min",
        "body": "Bring everything together until the chicken is fully cooked and the sauce or glaze has settled into a shiny, balanced finish. The final dish should look glossy and balanced, not watery, dull, or greasy."
      }
    ],
    "plating": [
      "Slice the chicken at a slight angle so the inside stays visible and the plate looks cleaner.",
  ...
  },
  {
    ...
    "notes": [
      "A dark crust matters more than constant flipping; leave the beef still long enough to colour.",
      "Rest beef after cooking so the juices stay in the meat instead of running across the plate.",
      "If the pan cools down and the meat turns grey, cook in smaller batches."
    ],
    "steps": [
      {
      ...
      },
      {
        ...
        "heat": "High",
        "time": "2-3 min",
        "body": "Use a heavy pan and let it heat until very hot before adding the oil. The goal is immediate contact and strong colour. The pan is ready when the oil looks loose and shimmery, not when it is smoking hard."
      },
      {
        "title": "Sear the first side",
        "heat": "High",
        "time": "2 min",
        "body": "Lay the steak away from you in the pan. Press lightly once for full contact, then leave it alone so the crust can build. Wait for real colour before turning because browning is where much of the flavour comes from."
      },
      {
  ...
  },
  {
    ...
    "steps": [
      ...
      },
      {
        ...
        "heat": "High",
        "time": "2-3 min",
        "body": "Use proper heat at the start so the beef sears instead of turning pale and watery. The pan is ready when the oil looks loose and shimmery, not when it is smoking hard."
      },
      {
        "title": "Build a crust or rich colour",
        "heat": "High",
        "time": "4-7 min",
        "body": "Leave the beef in contact with the pan long enough to take on a deep brown finish before turning or stirring. Wait for real colour before turning because browning is where much of the flavour comes from."
      },
      {
        "title": "Add depth",
        "heat": "Medium",
      ...
      },
      {
        ...
        "heat": "Low-medium",
        "time": "4-8 min",
        "body": "Check the doneness, adjust seasoning, and let the texture settle before serving. The final dish should look glossy and balanced, not watery, dull, or greasy."
      }
    ],
    "plating": [
      "Slice steak or beef across the grain for a neater look and a softer bite.",
  ...
  },
  {
    ...
    "notes": [
      "Pasta water is texture control — always save some before draining.",
      "If the sauce feels heavy, loosen it with pasta water rather than extra oil.",
    ...
    "steps": [
      ...
      },
      {
        ...
        "heat": "Medium",
        "time": "5-6 min",
        "body": "Cook the pancetta slowly until the fat renders and the edges turn lightly crisp. You want rich flavour, not burnt bits. The pan is ready when the oil looks loose and shimmery, not when it is smoking hard."
      },
      {
        "title": "Mix the sauce base",
        "heat": "No heat",
        "time": "2 min",
        "body": "Whisk the eggs, yolks, cheese, and plenty of black pepper in a bowl until thick and creamy. If the smell turns sharp or bitter, the heat is too high and the aromatics are starting to catch."
      },
      {
        "title": "Combine off the heat",
        "heat": "Residual heat",
        "time": "1-2 min",
        "body": "Turn the pan off, add the pasta to the pancetta, then stir through the egg mixture quickly. Add tiny splashes of pasta water until the sauce turns silky and coats every strand. The pan is ready when the oil looks loose and shimmery, not when it is smoking hard."
      },
      {
        "title": "Serve immediately",
        "heat": "No heat",
        "time": "1 min",
        "body": "Plate straight away while the sauce is glossy and loose, then finish with extra cheese and black pepper. The final dish should look glossy and balanced, not watery, dull, or greasy."
      }
    ],
    "plating": [
  ...
  },
  {
    ...
    "ingredients": [
      ...
      "2 garlic cloves or a small onion base",
      "Main sauce ingredients for this dish",
    ...
    "steps": [
      ...
      },
      {
        ...
        "heat": "Medium",
        "time": "3-5 min",
        "body": "Cook the garlic, onion, or base ingredients gently until fragrant, making sure nothing catches and turns bitter. If the smell turns sharp or bitter, the heat is too high and the aromatics are starting to catch."
      },
      {
        "title": "Build the main sauce",
        "heat": "Medium",
        "time": "4-6 min",
        "body": "Add the key sauce ingredients and let them come together into a smoother, fuller mixture rather than a watery one. If the smell turns sharp or bitter, the heat is too high and the aromatics are starting to catch."
      },
      {
        "title": "Combine pasta and sauce",
        "heat": "Low-medium",
        "time": "2-3 min",
        "body": "Add the pasta and toss until everything is coated. Loosen with pasta water if the sauce feels too tight. If the smell turns sharp or bitter, the heat is too high and the aromatics are starting to catch."
      },
      {
        "title": "Finish and serve",
        "heat": "No heat",
        "time": "1 min",
        "body": "Taste for seasoning, then finish with cheese, herbs, pepper, or an extra touch of richness before serving straight away. The final dish should look glossy and balanced, not watery, dull, or greasy."
      }
    ],
    "plating": [
      "Twirl the pasta into a neat mound rather than dropping it flat on the plate.",
  ...
  },
  {
    ...
    "steps": [
      ...
      },
      {
        ...
        "heat": "No heat",
        "time": "5-8 min",
        "body": "Combine the ingredients evenly, taking care not to overwork the mixture if the recipe needs a soft or tender texture. If the smell turns sharp or bitter, the heat is too high and the aromatics are starting to catch."
      },
      {
      ...
      },
      {
        ...
        "heat": "No heat",
        "time": "2 min",
        "body": "Add cream, sauce, fruit, or garnish so it feels complete rather than unfinished. The final dish should look glossy and balanced, not watery, dull, or greasy."
      }
    ],
    "plating": [
      "Let the dessert settle before plating so the shape holds and looks deliberate.",
  ...
  },
  {
    ...
    "steps": [
      ...
      },
      {
        ...
        "heat": "No heat",
        "time": "2 min",
        "body": "Whisk until smoother and slightly lighter in colour so the custard starts evenly. A fully chilled base always freezes into a smoother result."
      },
      {
        "title": "Temper the yolks",
        "heat": "No heat",
        "time": "2 min",
        "body": "Slowly pour a little hot dairy into the yolks while whisking so they warm gradually instead of scrambling. A fully chilled base always freezes into a smoother result."
      },
      {
        "title": "Cook the custard",
        "heat": "Low",
        "time": "5-7 min",
        "body": "Return everything to the pan and stir constantly until the mixture lightly coats the back of a spoon. A fully chilled base always freezes into a smoother result."
      },
      {
        "title": "Chill and churn",
        "heat": "Fridge / freezer",
        "time": "4 hr + churn",
        "body": "Cool the base completely, then churn or freeze using your preferred method until the texture turns smooth and scoopable. A fully chilled base always freezes into a smoother result."
      }
    ],
    "plating": [
  ...
  },
  {
    ...
    "steps": [
      ...
      },
      {
        ...
        "heat": "Low",
        "time": "2 min",
        "body": "Add the sugar and salt, stirring until fully dissolved and smooth. A fully chilled base always freezes into a smoother result."
      },
      {
        "title": "Cool completely",
        "heat": "No heat",
        "time": "2-4 hr",
        "body": "Chill the base until completely cold so the texture freezes more evenly. A fully chilled base always freezes into a smoother result."
      },
      {
        "title": "Freeze or churn",
        "heat": "Freezer",
        "time": "20-30 min churn",
        "body": "Freeze according to your method, stirring at intervals if you do not have an ice cream machine. A fully chilled base always freezes into a smoother result."
      },
      {
        "title": "Set before scooping",
        "heat": "Freezer",
        "time": "1-2 hr",
        "body": "Let it firm up slightly before serving so the scoops hold their shape. A fully chilled base always freezes into a smoother result."
      }
    ],
    "plating": [
      "Warm the scoop slightly or dip it in hot water for cleaner rounded scoops.",
  ...
  },
  {
    ...
    "ingredients": [
      "4 thick slices brioche or soft bread",
      "2 eggs",
      "80ml milk",
    ...
    "notes": [
      "Breakfast usually rewards gentler heat; rushing it often burns the outside first.",
      "Prep first, cook second — once the pan is hot, breakfast moves fast.",
      "Serve straight away because texture drops quickly with breakfast dishes."
    ],
    "steps": [
      {
      ...
      },
      {
        ...
        "heat": "No heat",
        "time": "1 min",
        "body": "Serve while hot with berries, maple syrup, or a dusting of icing sugar. The final dish should look glossy and balanced, not watery, dull, or greasy."
      }
    ],
    "plating": [
  ...
  },
  {
    ...
    "steps": [
      ...
      },
      {
        ...
        "heat": "Medium",
        "time": "2 min",
        "body": "Use a steady heat so the outside colours at the same pace the middle cooks. The pan is ready when the oil looks loose and shimmery, not when it is smoking hard."
      },
      {
      ...
      },
      {
        ...
        "heat": "Low",
        "time": "1-2 min",
        "body": "Add fillings, syrup, herbs, fruit, or cheese right at the end so they stay fresh and balanced. The final dish should look glossy and balanced, not watery, dull, or greasy."
      },
      {
        "title": "Serve immediately",
        "heat": "No heat",
        "time": "1 min",
        "body": "Plate and eat straight away while the dish still has its best texture. The final dish should look glossy and balanced, not watery, dull, or greasy."
      }
    ],
    "plating": [
      "Stack or layer breakfast dishes neatly so they look fuller and more deliberate.",
...
function saveNewRecipe() {
  ...
  const category = document.getElementById("fCategory").value.trim() || "Custom";
  const difficulty = document.getElementById("fDifficulty").value.trim() || "Custom";
  const time = document.getElementById("fTime").value.trim() || "Not set";
  const serves = document.getElementById("fServes").value.trim() || "Not set";
  const description = document.getElementById("fDescription").value.trim() || "A user-added recipe.";
  const tags = document.getElementById("fTags").value.split(",").map(x => x.trim()).filter(Boolean);
  const ingredients = getLines("fIngredients");
  const notes = getLines("fNotes");
  const rawSteps = getLines("fSteps");
  ...
  const newRecipe = {
    ...
    notes: notes.length ? notes : ["Taste as you go and steady the heat if the pan gets too aggressive."],
    steps,
    plating: [
...
modal.querySelector(".modal-backdrop").addEventListener("click", closeRecipe);
...
// ===== CLEAN RESTART BASE =====
(function () {
  if (window.__chefCleanRestartBaseDone) return;
  window.__chefCleanRestartBaseDone = true;

  const CLEAN_CATEGORIES = ["All", "Meats", "Salads", "Desserts", "Drinks", "Kids Menu"];

  function wipeRecipes() {
    try { localStorage.removeItem("chef_deluxe_custom_recipes"); } catch (e) {}

    if (Array.isArray(starterRecipes)) {
      starterRecipes.length = 0;
    }

    try { recipes = []; } catch (e) {}
    try { window.recipes = []; } catch (e) {}
  ...
  function renderCleanFilters() {
    ...
    wrap.innerHTML = CLEAN_CATEGORIES.map((cat, i) => `
      <button class="chip ${i === 0 ? 'active' : ''}" type="button" data-clean-category="${cat}">
        ${cat}
      </button>
    `).join("");

    wrap.querySelectorAll("[data-clean-category]").forEach(btn => {
      btn.addEventListener("click", () => {
  ...
  function hideOldExtras() {
    ["generatorBtn", "favouritesBtn", "surpriseBtn"].forEach(id => {
      const el = document.getElementById(id);
      if (el) el.style.display = "none";
    });
  }

  function renderCleanEmptyState() {
    const grid = document.getElementById("recipeGrid");
    if (!grid) return;
    grid.innerHTML = `
      <div class="empty-state clean-restart-empty">
        <h3>Clean base ready</h3>
        <p>All old recipes have been removed. Start rebuilding with new recipes in:</p>
        <p><strong>Meats</strong> · <strong>Salads</strong> · <strong>Desserts</strong> · <strong>Drinks</strong> · <strong>Kids Menu</strong></p>
      </div>
    `;
  }
