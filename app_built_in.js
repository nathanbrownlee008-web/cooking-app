...
function ensureBuiltInRecipes() {
  const builtIns = [
    {
      id: "builtin-perfect-loin-chops",
      title: "Perfect Loin Chops / Loin Steak",
      category: "Meats",
      difficulty: "Chef Fix",
      time: "15–20 min",
      serves: "2",
      description: "Juicy loin chops / loin steak with garlic powder, proper hob settings, thermometer temperatures, and clear step-by-step cooking.",
      tags: ["Meats", "Pork", "Steak", "Chops"],
      ingredients: [
        "2 loin chops or loin steaks (2–3cm thick)",
        "Salt",
        "Black pepper",
        "Garlic powder (1 tsp total)",
        "Paprika optional",
        "10–15g vegetable oil or sunflower oil or rapeseed oil",
        "20g butter",
        "5g butter for resting"
      ],
      ingredientSections: [
        {
          title: "Ingredients",
      ...
      notes: [
        "Use vegetable oil, sunflower oil, or rapeseed oil for the sear.",
        "Heat 5 = sear, heat 4 = main cooking, heat 3 = optional finish.",
        "Remove at 60–62°C and rest to about 63°C.",
        "Only use the covered finish if the centre is still below about 58°C."
      ],
      steps: [
        {
          ...
          heat: "No heat",
          time: "20–30 min",
          body: "Take the chops out of the fridge 20–30 minutes before cooking so they cook more evenly and stay tender."
        },
        {
          title: "Dry the meat",
          heat: "No heat",
          time: "1 min",
          body: "Pat both sides dry well with kitchen paper so the surface can sear properly."
        },
        {
          title: "Season",
          heat: "No heat",
          time: "1 min",
          body: "Season both sides with salt, black pepper, garlic powder, and optional paprika."
        },
        {
          title: "Preheat the pan",
          heat: "Hob 5",
          time: "2–3 min",
          body: "Heat the pan on hob setting 5 for 2–3 minutes, then add the oil. The oil should look shiny and lightly shimmering, not heavily smoking."
        },
        {
          title: "Sear the first side",
          heat: "Hob 5",
          time: "3–4 min",
          body: "Lay the chops in the pan and do not move them. Cook until the underside is golden brown."
        },
        {
          title: "Flip and baste",
          heat: "Hob 4",
          time: "3–4 min",
          body: "Flip the chops, turn the hob down to 4, add 20g butter, and baste continuously while the second side cooks."
        },
        {
          title: "Check the temperature",
          heat: "Hob 4",
          time: "1 min",
          body: "Check the centre with a thermometer. Remove the chops when they reach 60–62°C."
        },
        {
          title: "Optional finish if needed",
          heat: "Hob 3",
          time: "2–3 min",
          body: "Only if the centre is still below about 58°C, lower the hob to 3, cover loosely, and finish for 2–3 more minutes."
        },
        {
          title: "Rest",
          heat: "No heat",
          time: "5–10 min",
          body: "Rest the chops for 5–10 minutes and add 5g butter on top so it melts over the meat."
        }
      ]
    }
  ];
  ...
  builtIns.forEach(recipe => {
    const exists = recipes.some(item => item.id === recipe.id || item.title === recipe.title);
    if (!exists) {
